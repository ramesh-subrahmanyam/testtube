...
class PortfolioBacktester:
    ...
    def _aggregate_performance(self):
        ...
        # Create a combined exposure mask
        if aligned_positions:
            ...
            if num_exposure_days > 0:
                ...
                # Calculate daily returns using the same dollar_size denominator as regular Sharpe
                # This is consistent with how regular Sharpe is calculated
